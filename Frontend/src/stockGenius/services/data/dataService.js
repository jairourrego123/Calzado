...
const getResumenFinanciero = async (params={}) => {
  const response = await apiClient.get('/data/resumen-financiero/',params);
  return response.data;
};

export { getDataHome,getGanancias,getAnalisisDia,getResumenFinanciero};
