...
function ProductsSelectedEntry({products=[],handleEliminarProducto}) {
  if (!products.length) return <h5>Selecciona los productos que aumentarán su stock</h5>;
...
export default ProductsSelectedEntry