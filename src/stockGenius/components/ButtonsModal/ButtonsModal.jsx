...
function ButtonsModal({onClose,disable=false}) {
  return (
    ...
    <button  disabled={disable} className={`${disable?"":"stock-genius-component-general-form-button-submit"} stock-genius-button`} type="submit" style={disable ?{}:{backgroundColor:config.backgroundButton }} >Guardar</button>
  </div>
  )
}
